import { Linkedin, Github, Instagram, Mail, BookOpen, FileText, Download, Container } from "lucide-react";
...
const HeroSection = () => {
  const socialLinks = [
    ...
    { icon: Container, href: "https://hub.docker.com/u/YOUR_DOCKERHUB_USERNAME", label: "Docker Hub" },
